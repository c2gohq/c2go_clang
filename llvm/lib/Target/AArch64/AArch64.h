...
FunctionPass *createAArch64C2GoPtrSlotLivenessPass();
...
ModulePass *createAArch64C2GoLeafABIPass();
...
void initializeAArch64C2GoLeafABIPass(PassRegistry &);
void initializeAArch64C2GoPtrSlotLivenessPass(PassRegistry &);
