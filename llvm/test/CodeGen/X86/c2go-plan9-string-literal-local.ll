...
; GLOBL definition and every (SB) reference (X86 refs route through
; printPlan9MemRef / sanitizeLocalDataRef).
;
; RUN: llc %s -mtriple=x86_64-unknown-none-goabi --output-asm-variant=2 -o - \
; RUN:   | FileCheck %s
